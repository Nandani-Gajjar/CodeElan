...
import '../../../../DataObjects/ServiceData/CloudFoundationServiceData.dart';
import '../../../../DataObjects/TestimonialListData.dart';
import '../../../../Utils/Responsive.dart';
import '../../../../Utils/widgets.dart';

class BuildCloudFoundation extends StatefulWidget {
  const BuildCloudFoundation({Key? key}) : super(key: key);

  @override
  State<BuildCloudFoundation> createState() => _BuildCloudFoundationState();
}

class _BuildCloudFoundationState extends State<BuildCloudFoundation>
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              cloudFoundationServiceList[0].icon,
                              cloudFoundationServiceList[0].title,
                              cloudFoundationServiceList[0].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              cloudFoundationServiceList[2].icon,
                              cloudFoundationServiceList[2].title,
                              cloudFoundationServiceList[2].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              cloudFoundationServiceList[4].icon,
                              cloudFoundationServiceList[4].title,
                              cloudFoundationServiceList[4].subTitle)
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ServicesGrid(
                              cloudFoundationServiceList[1].icon,
                              cloudFoundationServiceList[1].title,
                              cloudFoundationServiceList[1].subTitle),
                          SizedBox(
                            height: height * .02,
                          ),
                          ServicesGrid(
                              cloudFoundationServiceList[3].icon,
                              cloudFoundationServiceList[3].title,
                              cloudFoundationServiceList[3].subTitle),
                        ],
                      ),
                    ),
                  ],
                  ...
                  children: [
                    SizeTransition(
                      ...
                      child: Container(
                          ...
                          child: Column(
                            children: [
                              howWorkWidget('Consultation',
                                  'We start by understanding your business goals and requirements. Our experts work closely with you to identify the best cloud solutions for your specific needs.'),
                              howWorkWidget('Assessment And Planning',
                                  'We conduct a thorough assessment of your existing infrastructure and applications. Based on the assessment, we develop a detailed plan that outlines the steps, timelines, and resources required for building your cloud foundation.'),
                              howWorkWidget('Implementation',
                                  'Our team executes the plan, setting up the necessary infrastructure, migrating data and applications, and configuring security measures. We follow best practices to ensure a smooth transition to the cloud.'),
                              howWorkWidget('Optimization And Monitoring',
                                  'Once your cloud foundation is established, we continuously monitor and optimize your infrastructure to enhance performance, reliability, and cost-efficiency. We proactively identify and resolve any issues to minimize downtime and maximize productivity.'),
                            ],
                          )),
                    ),
                    SizedBox(
        ...
        Row(
          ...
          children: [
            Container(
              ...
              child: ExclusiveContainer('Customized Solutions',
